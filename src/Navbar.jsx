// Navbar — Frank Anthony Portfolio
// Matches reference: monospace nav links, GitHub icon, theme toggle
// Active section tracked via IntersectionObserver
// Theme persisted in localStorage, applied to <html> as .dark
...
function useTheme() {
  ...
  useEffect(() => {
    // Read the class already set by the anti-flash script in index.html
        ...
        <div className="flex items-center gap-[18px]">
          ...
          >
            {dark ? (
              ...
              /* Half-moon icon (matches reference) */
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" strokeWidth="1.75"
                strokeLinecap="round" strokeLinejoin="round"
                aria-hidden="true"
